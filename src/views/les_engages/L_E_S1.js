...
const L_E_S1 = () => {
    ...
    return (
        <>
        <Helmet>
            <title>Les Engagés - Saison 1 - Astharté & Compagnie</title>
            <meta name="description" content="Découvrez 'Les Engagés', la première saison de la série captivante produite par Astharté & Compagnie." />
            ...
            {/* Open Graph Tags */}
            <meta property="og:title" content="Les Engagés - Saison 1 - Astharté & Compagnie" />
            ...
            <script type="application/ld+json">
                {JSON.stringify({
                    ...
                    "@type": "TVSeries",
                    "name": "Les Engagés - Saison 1",
                    "description": "La première saison de la série 'Les Engagés', produite par Astharté & Compagnie.",
                    "url": "https://astharte.com/les_engages_s1",
        ...
        <CRow className="bg-image-s-le">
            <CCol xs={12}>
                <div className="container">
                    ...
                    <h3 className="les_engages-title-h3">Saison 1</h3>
                    ...
                    <ScrollTrigger onEnter={() => setImageClass1("slide-from-left")}>
                      <div className={`flex-container ${imageClass1}`}>
                        <div className="text-container-S1 special-text-container">
                          <h3 className="les_engages-syn">Présentation</h3>
                            ...
                            <br></br>
                            <h3 className="les_engages-syn">Synopsis</h3>
                            <p className="text-left text-bg texte">
                            ...
                            <h3 className="les_engages-syn texte">Acteurs principaux</h3>
                            <p className="text-left text-bg texte">
                            <ul>
                        ...
                        <img src={affichele1} alt="les_engages Image 1" className="img-thumbnail-large" />
                    </div>
                    </ScrollTrigger>
                    ...
                    offset={{ top: 50 }}>
                        <div className={`les_engagesRight-container ${imageClass2}`}>
                            <img src={S1lesengagesWord1} alt="les_engages Image 2" className="les_engagesRight-imageStyle" />
                    ...
                    <div className={`les_engages-flex-container ${imageClass3}`}>
                        ...
                        <img src={S1lesengagesWord2} alt="les_engages Image 3" className="les_engages-img-thumbnail" />
                    </div>
                    </ScrollTrigger>

                    <ScrollTrigger onEnter={() => setImageClass4("fade-in active")} offset={{ top: 200 }}>
                    <div className={`${imageClass4}`}>
        <img src={S1lesengagesbottom1} alt="les_engages Image 4" className="img-thumbnail" />
        <img src={S1lesengagesbottom2} alt="les_engages Image 4" className="img-thumbnail" />
        <img src={S1lesengagesbottom3} alt="les_engages Image 4" className="img-thumbnail" />
