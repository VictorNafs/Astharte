        ...
        <CRow className="bg-image-s-le">
            <CCol xs={12}>
                <div className="container">
                    ...
                    <h3 className="les_engages-title-h3">Saison 3</h3>
                    ...
                    <ScrollTrigger onEnter={() => setImageClass1("slide-from-left")}>
                      <div className={`flex-container ${imageClass1}`}>
                        ...
                        <img src={affichele3} alt="les_engages Image 1" className="img-thumbnail-large" />
                    </div>
                    </ScrollTrigger>
                    ...
                    offset={{ top: 50 }}>
                        <div className={`les_engagesRight-container ${imageClass2}`}>
                            <img src={S3lesengagesWord1} alt="les_engages Image 2" className="les_engagesRight-imageStyle" />
                    ...
                    <div className={`les_engages-flex-container ${imageClass3}`}>
                        ...
                        <img src={S3lesengagesWord2} alt="les_engages Image 3" className="les_engages-img-thumbnail" />
                    </div>
                    </ScrollTrigger>

                    <ScrollTrigger onEnter={() => setImageClass4("fade-in active")} offset={{ top: 200 }}>
                    <div className={`${imageClass4}`}>
        <img src={S3lesengagesbottom1} alt="les_engages Image 4" className="img-thumbnail" />
        <img src={S3lesengagesbottom2} alt="les_engages Image 4" className="img-thumbnail" />
        <img src={S3lesengagesbottom3} alt="les_engages Image 4" className="img-thumbnail" />
