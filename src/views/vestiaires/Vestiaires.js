  ...
  <img src={require('src/assets/images/palm-right.png')} alt="Palme droite" className="palm-half" />
                    ...
                    <ScrollTrigger onEnter={() => setImageClass1("slide-from-left")}>
                      <div className={`flex-container ${imageClass1}`}>
                        ...
                        <h1 className="vestiaires-syn">Synopsis</h1>
                            ...
                            <br></br>
                            <h3 className="vestiaires-syn">Acteurs principaux</h3>
                            <p className="text-left text-bg texte">
                                <ul>
                        ...
                        <img src={affichevestiaires13} alt="vestiaires Image 1" className="img-thumbnail-large" />
                    </div>
                    </ScrollTrigger>
                    <div style={{ clear: 'both' }}></div>

                    <ScrollTrigger 
    onEnter={() => setImageClass2("slide-from-right vestiairesRight-slideAnim")} 
    offset={{ top: 50 }}
>
    <div className={`vestiairesRight-container ${imageClass2}`}>
        <img src={vestiairesWord1} alt="vestiaires Image 2" className="vestiairesRight-imageStyle" />
        <div className="vestiairesRight-textSection text-bg">
        <h3 className="white-title">Équipe artistique</h3>   
                <ul>
                    ...
                    <ScrollTrigger 
                    onEnter={() => setImageClass3("slide-from-left vestiaires-slide-in")} 
                    offset={{ top: 50 }}>
                    <div className={`vestiaires-flex-container ${imageClass3}`}>
                        <div className="vestiaires-text-left text-bg">
                        ...
                        <img src={vestiairesWord2} alt="vestiaires Image 3" className="vestiaires-img-thumbnail" />
                    </div>
                    </ScrollTrigger>

                    <ScrollTrigger onEnter={() => setImageClass4("fade-in active")} offset={{ top: 200 }}>
                    <div className={`${imageClass4}`}>
        <img src={vestiairesbottom1} alt="vestiaires Image 4" className="img-thumbnail" />
        <img src={vestiairesbottom2} alt="vestiaires Image 4" className="img-thumbnail" />
        <img src={vestiairesbottom3} alt="vestiaires Image 4" className="img-thumbnail" />
